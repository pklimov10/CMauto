---Количество файлов не совпадает с количеством сообщений, содержащих хэш файла
select
	count(*)
from cmi_msg_in
	join cl_exception
...
where cmi_route.name like 'SED_EP_RSHB_OUTPUT' and cl_exception.name = 'ILLEGAL_FILES_COUNT'
